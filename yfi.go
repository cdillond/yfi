...
// yfi IS NOT AFFILIATED WITH OR PRODUCED BY YAHOO.
// DATA OBTAINED THROUGH yfi SHOULD BE USED ONLY FOR PERSONAL, NON-COMMERCIAL APPLICATIONS.
// yfi attempts to unify several versions of the Yahoo Finance API, but
// this can lead to some confusion. Presently, there are 3 main representations of
